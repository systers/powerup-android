...
public class PowerUpUtils {
    ...
    public static final int[] HAIR_IMAGES = {R.drawable.hair1,R.drawable.hair2,R.drawable.hair3,R.drawable.hair7,R.drawable.hair8,R.drawable.hair10,R.drawable.hair11,R.drawable.hair15,R.drawable.hair16,R.drawable.hair4,R.drawable.hair5,R.drawable.hair6,R.drawable.hair9,R.drawable.hair12,R.drawable.hair13,R.drawable.hair14};
    ...
    public static final int[] ACCESSORIES_IMAGES = {R.drawable.acc2,R.drawable.acc3,R.drawable.acc1,R.drawable.acc4};
