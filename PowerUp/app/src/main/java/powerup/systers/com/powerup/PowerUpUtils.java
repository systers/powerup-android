...
public class PowerUpUtils {
    ...
    public static final String SWIM_SINK_SOUND_ACTION = "sink_to_swim_sound_action";
    public static final String SWIM_SINK_SOUND_EXTRA = "sink_to_swim_sound_action_extra";
    public static final String SWIM_SINK_SOUND_PAUSE = "sink_to_swim_sound_action_pause";
    public static final String SWIM_SINK_SOUND_RESUME = "sink_to_swim_sound_action_resume";
