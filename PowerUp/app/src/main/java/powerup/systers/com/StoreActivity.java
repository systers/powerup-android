...
public class StoreActivity extends AppCompatActivity {
    ...
    class GridAdapter extends BaseAdapter {
        ...
        private void purchase(final int price, final int index) {
            ...
            String message = getString(R.string.warning_purchase_message);
            message = String.format(message, price);
            builder.setTitle(R.string.title_warning)
                    .setMessage(message);
            builder.setPositiveButton(R.string.positive_button_purchase_warning, new DialogInterface.OnClickListener() {
                public void onClick(final DialogInterface dialogInterface, int id) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(StoreActivity.this);
                    builder.setTitle(R.string.title_yay)
                            .setMessage(R.string.purchase_message_successful);
                    builder.setPositiveButton(R.string.purchase_successful_confirm, new DialogInterface.OnClickListener() {
            ...
            builder.setNegativeButton(R.string.negative_button_purchase_warning, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    dialog.dismiss();
                }
            });
