...
public class StoreActivity extends AppCompatActivity {
    ...
    private void showAlreadySelectedItemWarning() {
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle(R.string.already_selected_title)
                .setMessage(R.string.already_selected_message)
                .setPositiveButton(R.string.already_selected_ok, new DialogInterface.OnClickListener() {
                    @Override
