...
public class ScenarioOverLevel2Activity extends AppCompatActivity implements ScenarioOverLevel2Contract.IScenarioOverLevel2View{
    ...
    private ScenarioOverLevel2Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new ScenarioOverLevel2Presenter(this, dataSource);
