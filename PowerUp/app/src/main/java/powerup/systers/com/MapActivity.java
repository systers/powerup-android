    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.isEnabled()){
                ...
                } else if (new MiniGameSessionManager(MapActivity.this).isIncomplete(MiniGameSessionManager.MINESWEEPER)) { //if minesweeper game was left incomplete
                    startActivity(new Intent(MapActivity.this, MinesweeperGameActivity.class));
                } else if (new MiniGameSessionManager(MapActivity.this).isIncomplete(MiniGameSessionManager.SINK_TO_SWIM)){
                    startActivity(new Intent(MapActivity.this, SinkToSwimGame.class));
                } else if (new MiniGameSessionManager(MapActivity.this).isIncomplete(MiniGameSessionManager.VOCAB_MATCH)){
