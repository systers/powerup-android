...
public class MapActivity extends Activity {
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (new MinigamesSessionManager(MapActivity.this).hasStarted(MinigamesSessionManager.MINESWEEPER)) {
                startActivity(new Intent(MapActivity.this, MinesweeperGameActivity.class));
            } else if (new MinigamesSessionManager(MapActivity.this).hasStarted(MinigamesSessionManager.SINK_TO_SWIM)) {
                startActivity(new Intent(MapActivity.this, SinkToSwimGame.class));
            } else if (new MinigamesSessionManager(MapActivity.this).hasStarted(MinigamesSessionManager.VOCAB_MATCH)) {
