...
1. Make sure you have downloaded the latest version of [Android Studio][androidstu]. It works on Linux, Windows and Mac. Download the correct version for your OS. If you are using Android Studio 3.0 use these resources (https://developer.android.com/studio/build/gradle-plugin-3-0-0-migration.html / https://developer.android.com/studio/releases/gradle-plugin.html) 
2. Go to [the project repo][gitpowerandroid] and fork it by clicking "_Fork_" 
3. If you are working on Windows, download [Git Bash for Windows][gitbash] to get a full Unix bash with Git functionality
...
7. Fetch the latest version of code from branch "_GSoC17_".
...
1. Go into [the Github repo][gitpowerandroid] and create a pull request explaining your changes
...
[Click][wikihowtocontribute] here to find the contributing guidelines for the project and follow them before sending a contribution.

## Documentation of PowerUp (Android)
Here's the link to the official documentation:
[Visit Documentation!][visitdoc]
...
[androidstu]: https://developer.android.com/sdk/index.html
[gitpowerandroid]: https://github.com/systers/powerup-android/
[gitbash]: https://git-for-windows.github.io/
[wikihowtocontribute]: https://github.com/systers/powerup-android/wiki/How-to-Contribute
[visitdoc]: http://chetnagsocpowerupandroid.blogspot.in/2015/05/database-design.html
